...
describe('ai template literal function', () => {
  ...
  describe('text generation', () => {
    ...
    it('should incorporate template variables', async () => {
    ...
    it.skip('should accept temperature settings', async () => {
    ...
    it.skip('should accept max token limit', async () => {
  ...
  describe('structured data generation', () => {
    it.skip('should handle simple schemas', async () => {
    ...
    it.skip('should handle complex schemas', async () => {
    ...
    it.skip('should handle array schemas', async () => {
    ...
    it.skip('should validate output against schemas', async () => {
