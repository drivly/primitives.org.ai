...
describe('list function', () => {
  ...
  describe('basic functionality', () => {
    ...
    it('should have proper typing for array items', async () => {
  ...
  describe('AsyncIterable interface', () => {
    it.skip('should support for-await-of iteration', async () => {
  ...
  describe('edge cases', () => {
    ...
    it('should handle very long prompts', async () => {
      const longPrompt = 'List programming languages that are particularly well-suited for ' +
