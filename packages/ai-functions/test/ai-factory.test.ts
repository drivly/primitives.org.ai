...
describe('AI factory function', () => {
  ...
  it('should create a type-safe function definition', async () => {
    const testAI = AI({
  ...
  it.skip('should execute functions with various inputs', async () => {
    const testAI = AI({
      generateContent: { 
        title: 'string', 
        content: 'string', 
  ...
  it.skip('should handle complex nested schema', async () => {
    const testAI = AI({
      getProductDetails: { 
        product: { 
          id: 'string', 
