    ...
    return _ts_generator(this, function (_state) {
      switch (_state.label) {
        case 0:
          ...
          ;(_config_modelName = config.modelName),
            (modelName = _config_modelName === void 0 ? 'google/gemini-2.5-flash-preview' : _config_modelName),
            (_config_system = config.system),
            (system =
              _config_system === void 0
                ? 'You are an expert business consultant specializing in the StoryBrand framework for clarifying marketing messages'
                : _config_system),
            (_config_temperature = config.temperature),
            (temperature = _config_temperature === void 0 ? 0.7 : _config_temperature)
        ...
        case 2:
          result = _state.sent()
          return [2, JSON.parse(result.text)]
        case 3:
          error = _state.sent()
      ...
      switch (_state.label) {
        case 0:
          ...
          ;(_config_modelName = config.modelName),
            ...
            (_config_system = config.system),
            (system =
              _config_system === void 0 ? 'You are an expert business consultant specializing in Lean Canvas for startups and new products' : _config_system),
            (_config_temperature = config.temperature),
            (temperature = _config_temperature === void 0 ? 0.7 : _config_temperature)
          inputStr = typeof input === 'string' ? input : JSON.stringify(input)
