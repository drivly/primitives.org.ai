...
export default function BasicExample() {
  return (
    <div className='space-y-16'>
      ...
      <Hero title='Welcome to AI Components' subtitle='Pre-wrapped UI components with AI-generated content' ctaText='Get Started' ctaLink='#' />

      {/* Hero with fully AI-generated content */}
      <Hero prompt='Generate a hero section for a SaaS product that helps developers build AI-powered applications' />

      {/* Features component with AI-generated content */}
      <Features prompt='Generate features for a UI component library' count={3} />

      {/* FAQs with custom title and AI-generated questions */}
      <FAQs title='Common Questions' prompt='Generate FAQs about AI components' count={3} />
      ...
      <Testimonials prompt='Generate testimonials for a UI component library' count={2} />
