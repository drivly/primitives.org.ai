...
export function CTA({ model = 'gpt-4o', prompt, stream = true, className, title, description, primaryCta, secondaryCta, children }: CTAProps) {
        ...
        return (
          <div className={cn('py-16 px-4 bg-muted/50', className)}>
            ...
            <div className='max-w-4xl mx-auto text-center'>
              <h2 className='text-3xl font-bold'>{ctaTitle || (isStreaming ? 'Generating title...' : 'Ready to get started?')}</h2>
