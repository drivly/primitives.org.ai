...
export function FAQs({ model = 'gpt-4o', prompt, stream = true, className, title, count = 5, items }: FAQsProps) {
        ...
        return (
          <div className={cn('py-12 px-4', className)}>
            ...
            <div className='max-w-3xl mx-auto'>
              <h2 className='text-3xl font-bold text-center mb-8'>{faqTitle || (isStreaming ? 'Generating FAQs...' : 'Frequently Asked Questions')}</h2>
