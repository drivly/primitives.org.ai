 ...
 */
export function Component({ description, model = 'gpt-4o', contextProps = {}, stream = true, className }: ComponentProps) {
...
`
  ...
  return (
    <AI prompt={prompt} model={model} schema={schema} stream={stream}>
      ...
      {(content: any, { isStreaming, error }: { isStreaming: boolean; error: Error | null }) => {
        ...
        return (
          <>
            ...
            <div className={cn('ai-generated-component', className)} dangerouslySetInnerHTML={{ __html: content.jsx }} />
          </>
        )
      }}
    </AI>
