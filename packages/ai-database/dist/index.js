...
var createPayloadDB = function (payload) {
  ...
  try {
        ...
        findOne: /*#__PURE__*/ _async_to_generator(function () {
          ...
          return _ts_generator(this, function (_state) {
            switch (_state.label) {
              ...
              case 1:
                result = _state.sent()
                return [2, ((_result_docs = result.docs) === null || _result_docs === void 0 ? void 0 : _result_docs[0]) || null]
            }
          })
        }),
        get: (function () {
    ...
    for (
      var _iterator = Object.keys(collections)[Symbol.iterator](), _step;
      !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
      _iteratorNormalCompletion = true
    )
      _loop()
  ...
  var _ref = _async_to_generator(function (config) {
    ...
    return _ts_generator(this, function (_state) {
      switch (_state.label) {
        ...
        case 2:
          payload = _state.sent()
          return [2, createPayloadDB(payload)]
        case 3:
          error = _state.sent()
